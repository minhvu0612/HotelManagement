...
import { hoavan, suite } from "../../Base/UseImages/UseImages";
            ...
            </div>
            {
                list ? (
                    <div className = "list-room-rooms">
                        {
                            list.map((element, key) => <RoomShow key = {key} show={showForm} />)
                        }
                    </div>
                ):null
            }
